...
def build_transforms(img_size, center_crop=False):
    ...
    if center_crop:
        ...
        t.append(transforms.Resize(img_size, interpolation="bicubic"))
...
model_urls = {
    "focalnet_tiny_srf": "https://github.com/microsoft/FocalNet/releases/download/v1.0.0/focalnet_tiny_srf.pth",
    "focalnet_tiny_lrf": "https://github.com/microsoft/FocalNet/releases/download/v1.0.0/focalnet_tiny_lrf.pth",
    "focalnet_small_srf": "https://github.com/microsoft/FocalNet/releases/download/v1.0.0/focalnet_small_srf.pth",
    "focalnet_small_lrf": "https://github.com/microsoft/FocalNet/releases/download/v1.0.0/focalnet_small_lrf.pth",
    "focalnet_base_srf": "https://github.com/microsoft/FocalNet/releases/download/v1.0.0/focalnet_base_srf.pth",
    "focalnet_base_lrf": "https://github.com/microsoft/FocalNet/releases/download/v1.0.0/focalnet_base_lrf.pth",
